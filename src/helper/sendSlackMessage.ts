...
const BOT_USER_OAUTH_TOKEN = "xoxp-1891434848919-2754300617426-3920888349718-5033902fc0a147a62011ed7bea556597";
...
export const sendSlackMessage = async (message: string) => {
  ...
  try {
    ...
    const result = await client.chat.postMessage({
      ...
      token: "xoxp-1891434848919-2754300617426-3920888349718-5033902fc0a147a62011ed7bea556597",
      channel: "C03T3JHGMMX",
      text: message,
