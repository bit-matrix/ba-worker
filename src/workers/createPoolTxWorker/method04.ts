...
import { part2c } from "./helper/part2c";
import { part3 } from "./helper/part3";
import { sendRawTransaction } from "./helper/sendRawTransaction";

export const method04 = async (pool: Pool, poolConfig: BmConfig, ctx: BmCtxNew): Promise<string | undefined> => {
  console.log("Pool tx creating on method 04 for ctx new id: " + ctx.commitmentTx.txid);
  ...
  try {
    ...
    const p2: string = part2c(pool, poolConfig, ctx.callData);
