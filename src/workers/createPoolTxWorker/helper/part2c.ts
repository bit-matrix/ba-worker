...
import { calcRecipientValueC, getRecipientScriptPubkey, getTxFeeServiceCommission, toHex64BE } from "./common";

// tx outputs
export const part2c = (pool: Pool, poolConfig: BmConfig, callData: CallData): string => {
  if (callData.method !== CALL_METHOD.REMOVE_LIQUIDITY) throw new Error("part2c error. Calldata method: " + callData.method + "! Nasil geldin buraya??");
  ...
  const p2 =
    ...
    "01" +
    recipientAssetLE_1 + // "RECEPIENT_ASSET_ID_REVERSE (L-BTC or TOKEN)" // 25d02aa3a6b673eefaaff069a84d32607f8756116b52520823bc3af84dbc3c21
    "01" +
    user_quote_received + // "RECEPIENT_VALUE" // 000000000eb8ebc0
    "00" +
    "16" +
    ...
    "01" +
    recipientAssetLE_2 + // "RECEPIENT_ASSET_ID_REVERSE (L-BTC or TOKEN)" // 25d02aa3a6b673eefaaff069a84d32607f8756116b52520823bc3af84dbc3c21
    "01" +
    user_token_received + // "RECEPIENT_VALUE" // 000000000eb8ebc0
    "00" +
    "16" +
    recipientScriptPubkey + // "RECEPIENT_SCRIPTPUBKEY" // 002062b5685478a2648d2d2eac4588fd5e8b51d9bdc34ebf942aa3310575a6227d52
    // #6 output: OP_RETURN
